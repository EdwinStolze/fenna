 ...
 * @method void renderOrProcessReady(InputfieldForm $form) Called when ready to render OR process. Added 0.4.7
...
class FormBuilderProcessor extends WireData {
	...
	protected function ___renderReady($form, $formFile = '', array $vars = array()) {
		...
		$this->renderOrProcessReady($form);
	 ...
	 * 
	 */
	protected function ___renderOrProcessReady($form) { }
